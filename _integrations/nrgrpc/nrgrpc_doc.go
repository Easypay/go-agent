...
//
// Full server example:
// https://github.com/Easypay/go-agent/blob/master/_integrations/nrgrpc/example/server/server.go
//
...
//
// Full client example:
// https://github.com/Easypay/go-agent/blob/master/_integrations/nrgrpc/example/client/client.go
package nrgrpc
