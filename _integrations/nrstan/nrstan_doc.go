...
// (https://godoc.org/github.com/Easypay/go-agent/_integrations/nrnats/#StartPublishSegment)
...
// https://github.com/Easypay/go-agent/blob/master/_integrations/nrstan/examples/main.go
package nrstan
