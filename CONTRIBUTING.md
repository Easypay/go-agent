...
When contributing a new integration package, please follow the [Writing a New Integration Package](https://github.com/Easypay/go-agent/wiki/Writing-a-New-Integration-Package) wiki page.
