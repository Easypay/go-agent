...
//
// Full server example:
// https://github.com/Easypay/go-agent/blob/master/v3/integrations/nrgrpc/example/server/server.go
//
// Client
//
...
//
// Full client example:
// https://github.com/Easypay/go-agent/blob/master/v3/integrations/nrgrpc/example/client/client.go
package nrgrpc
