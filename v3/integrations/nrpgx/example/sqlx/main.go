...
//	import (
//		"github.com/jmoiron/sqlx"
//		_ "github.com/Easypay/go-agent/v3/integrations/nrpgx"
//	)
//
//	func main() {
...
// `InstrumentSQLDriver`
// (https://godoc.org/github.com/Easypay/go-agent#InstrumentSQLDriver) API.
// See
// https://github.com/Easypay/go-agent/blob/master/v3/integrations/nrmysql/nrmysql.go
// for a full example.
//
